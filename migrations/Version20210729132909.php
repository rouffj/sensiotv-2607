 ...
 */
final class Version20210729132909 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Added user.last_login_at column';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(50) NOT NULL COLLATE BINARY, last_name VARCHAR(100) NOT NULL COLLATE BINARY, email VARCHAR(150) NOT NULL COLLATE BINARY, phone VARCHAR(30) DEFAULT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, roles CLOB DEFAULT NULL --(DC2Type:json)
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, first_name, last_name, email, phone, password, roles FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(100) NOT NULL, email VARCHAR(150) NOT NULL, phone VARCHAR(30) DEFAULT NULL, password VARCHAR(255) NOT NULL, roles CLOB DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO user (id, first_name, last_name, email, phone, password, roles) SELECT id, first_name, last_name, email, phone, password, roles FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
    }
}
